...
dirData["/bar.ts"] = [decode("Y29uc29sZS5sb2coImJhciIpOwo="), "text/typescript"];
dirData["/foo.txt"] = [decode("Zm9vCg=="), "text/plain"];
dirData["/index.html"] = [decode("SGVsbG8hCg=="), "text/html"];
...
Deno.test("readDirCreateSource with root", async () => {
  assertStringIncludes(
    ...
    `
const dirData: Record<string, [Uint8Array, string]> = {};
dirData["/root/bar.ts"] = [decode("Y29uc29sZS5sb2coImJhciIpOwo="), "text/typescript"];
dirData["/root/foo.txt"] = [decode("Zm9vCg=="), "text/plain"];
dirData["/root/index.html"] = [decode("SGVsbG8hCg=="), "text/html"];
`.trim(),
  );
});
